      ...
      >
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-0.5 text-xs uppercase tracking-widest text-white/30">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={onClose}
            className="rounded-xl p-2 text-white/30 transition-colors hover:bg-white/[0.04] hover:text-white"
          >
        ...
        <div className="mb-5 rounded-2xl bg-white/[0.03] p-4">
          <p className="text-sm leading-relaxed text-white/50">{taskTitle}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div
            ...
            className={`flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed p-10 transition-all duration-300 ${
              dragActive
                ? "border-gold-400/50 bg-gold-400/[0.05] shadow-[0_0_30px_rgba(212,160,33,0.1)]"
                : file
          ...
          >
            {file ? (
              <motion.div initial={{ scale: 0.8 }} animate={{ scale: 1 }} className="text-center">
                ...
                <p className="text-sm font-medium text-green-300/80">{file.name}</p>
              ...
              <>
                ...
                <p className="text-sm text-white/40">
                  ...
                  <span className="font-medium text-gold-400">browse</span>
                </p>
          ...
          <div className="flex gap-3">
            ...
            <motion.button
              ...
              className="btn-primary flex-1 py-3 text-sm uppercase tracking-wide disabled:cursor-not-allowed disabled:opacity-40"
            >
              {loading ? (
